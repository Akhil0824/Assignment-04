 ...
 * 
 */
public class EditJPanelperson extends javax.swing.JPanel {
    ...
    public EditJPanelperson(Persondeschistory history) {
        initComponents();
...
// this button is used to uptade after edit 
         // for updating array and refreshing table 
        String address=txtaddress.getText();
        String pname=txtname.getText();
        String community=txtcomm.getText();
   String city=txtcity.getText();
